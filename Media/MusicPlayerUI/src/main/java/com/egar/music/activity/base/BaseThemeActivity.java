 ...
 * @author Jun.Wang
 */
public abstract class BaseThemeActivity extends BaseExtendActionsActivity implements ThemeActions, ThemeControllerListener {
    //TAG
    ...
    public int getThemeValue(boolean isCallByController) {
        return SettingsSysUtil.getThemeVal(this);
    }
