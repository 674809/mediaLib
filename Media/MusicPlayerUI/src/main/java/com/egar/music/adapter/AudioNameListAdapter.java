 ...
 * @author Jun.Wang
 */
public class AudioNameListAdapter extends ArrayAdapter<ProAudio> implements SectionIndexer {
    // TAG
     ...
     */
    public AudioNameListAdapter(Context context) {
        super(context, 0);
        mContext = context;
    ...
    public View getView(final int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mLayoutInflater.inflate(R.layout.activity_music_list_frag_names_item, parent, false);
