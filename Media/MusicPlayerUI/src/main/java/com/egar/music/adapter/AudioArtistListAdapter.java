...
public class AudioArtistListAdapter<T> extends BaseArrAdapter<T> implements SectionIndexer {
    // TAG
    ...
    public AudioArtistListAdapter(@NonNull Context context, int resource) {
    ...
    private void setPlayingMedia(ProAudio playingMedia) {
        try {
            ...
            this.mPlayingArtist = mPlayingMedia.getArtist();
        } catch (Exception e) {
        }
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.activity_music_list_frag_artists_item, parent, false);
        ...
        if (tItem instanceof ProAudio) {
            ...
            try {
                if (TextUtils.equals(mPlayingArtist, filterMedia.sortStr)) {
                    holder.tvIdx.setTextColor(mHlFontColor);
                    holder.tvDesc.setTextColor(mHlFontColor);
